...
class controller(Sofa.PythonScriptController):
    ...
    def initGraph(self, node):
            ...
            # print("node: ", node)
            self.node = node
            self.finger1Node=self.node.getChild('iab_1')
            self.finger2Node=self.node.getChild('iab_2')
            self.finger3Node=self.node.getChild('iab_3')
            self.finger3Node=self.node.getChild('iab_4')
    ...
    def onKeyPressed(self,c):
            ...
            self.MecaObject3=self.finger4Node.getObject('tetras');
            ...
            self.pressureConstraint4 = self.pressureConstraint3Node.getObject('SurfacePressureConstraint')
