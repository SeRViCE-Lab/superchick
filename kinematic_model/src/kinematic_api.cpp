...
int main(int argc, char **argv)
{
  ...
  ros::Publisher robot_state_publisher = node_handle.advertise<moveit_msgs::DisplayRobotState>( "superchick_robot_state", 1 );
  ...
  /* Get the names of the joints in the base_link*/
