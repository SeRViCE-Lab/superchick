# Contributing to Superchicko (C++11, 14, Torch 7, Lua 5.1/5.2,Python 2.7)
...
The [issue tracker](https://github.com/service-lab/superchicko](#features)
and [submitting pull requests](#pull-requests), but please respect the following
restrictions:

* Please **do not** use the issue tracker for personal support requests (email the maintainer:
  [olalekan.ogunmolu@utdallas.edu](olalekan.ogunmolu@utdallas.edum)).
...
Feature requests are welcome to be filed. Superchicko is open-sourced;
...
1. [Fork](https://help.github.com/articles/fork-a-repo) the project, clone your
   ...
   git clone https://github.com/<your-username>/superchicko.git
   # Navigate to the newly cloned directory
   cd superchicko
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/service-lab/superchick0.git
   ```
