...
path = os.path.join('/sofa/applications/plugins/SoftRobots/docs/tutorials/PneunetGripper/details/data/mesh/')
...
def createScene(rootNode):
    ...
    planeNode.createObject('OglModel',name="floorVisual", src="@floorLoader", color="1 0 0 1",rotation="0 0 270", scale =10, translation="-122 0 0")
    ...
    cavity.createObject('SurfacePressureConstraint', name="SurfacePressureConstraint", template='Vec3d', value="0.0001", triangles='@topo.triangles', visualization='0', drawScale='0.0002', valueType="pressure")
    ...
    modelVisu.createObject('OglModel', name="pneuLoader", template='ExtVec3f', color='0.7 0.7 0.7 0.6',translation = translateFinger1)
    ...
    modelVisu.createObject('OglModel', name="cavVizLoader", filename="@cavLoader", template='ExtVec3f', color='0.7 0.7 0.7 0.6',rotation=str(360 - angle1*180/math.pi)+ " 0 0", translation=translateFinger2)
    modelVisu.createObject('BarycentricMapping')
    ...
    modelVisu.createObject('OglModel', name="modelLoader", template='Vec3f', color='0.7 0.7 0.7 0.6',rotation=str(360 - angle2*180/math.pi)+ " 0 0", translation=translateFinger3)
    modelVisu.createObject('BarycentricMapping')
