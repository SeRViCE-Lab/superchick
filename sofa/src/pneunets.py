...
def createScene(rootNode):
		...
		rootNode.createObject('BackgroundSetting', color='0 0.168627 0.211765')
                ...
                planeNode.createObject('OglModel',name="Visual", src="@loader", color="1 0 0 1",rotation="0 0 270", scale =10, translation="-122 0 0")
	...
	##########################################
		...
		##########################################
                ...
                modelVisu.createObject('OglModel', filename="@loader", template='ExtVec3f', color='0.7 0.7 0.7 0.6',translation = translateFinger1)
	...
	##########################################
		...
		##########################################
                ...
                modelVisu.createObject('OglModel', filename="@loader", template='ExtVec3f', color='0.7 0.7 0.7 0.6',rotation=str(360 - angle1*180/math.pi)+ " 0 0", translation=translateFinger2)
                modelVisu.createObject('BarycentricMapping')
	...
	##########################################
		...
		##########################################
                ...
                modelVisu.createObject('OglModel', filename="@loader", template='ExtVec3f', color='0.7 0.7 0.7 0.6',rotation=str(360 - angle2*180/math.pi)+ " 0 0", translation=translateFinger3)
                modelVisu.createObject('BarycentricMapping')
