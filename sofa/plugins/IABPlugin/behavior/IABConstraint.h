...
*                                                                             *
******************************************************************************/
#ifndef SOFA_CORE_BEHAVIOR_IABCONSTRAINT_H
#define SOFA_CORE_BEHAVIOR_IABCONSTRAINT_H
...
class SOFA_IABPlugin_API IABConstraint : public IABBaseConstraint
{
public:

    SOFA_CLASS(SOFA_TEMPLATE(IABConstraint,DataTypes), IABBaseConstraint);
...
public:
    ...
    static std::string templateName(const IABConstraint<DataTypes>* = NULL) ;
    ...
    using IABBaseConstraint::getConstraintViolation; // to avoid warning about hidden overloaded virtual function
...
protected:
    ...
    IABConstraint(MechanicalState<DataTypes> *mm = NULL);
    ~IABConstraint() override;
