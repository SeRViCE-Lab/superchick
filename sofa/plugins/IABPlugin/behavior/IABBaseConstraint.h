...
*                                                                             *
******************************************************************************/
#ifndef SOFA_CORE_BEHAVIOR_IABBASECONSTRAINT_H
#define SOFA_CORE_BEHAVIOR_IABBASECONSTRAINT_H
...
class SOFA_IABPlugin_API IABBaseConstraint : public BaseConstraint
{
public:

    SOFA_CLASS(IABBaseConstraint, BaseConstraint);
